...
namespace lingvo.ts
{
    ...
    public sealed class BinaryModelConfig
    {
        ...
        public BinaryModelConfig() => _ModelFilenames = new HashSet< string >( StringComparer.InvariantCultureIgnoreCase );
        ...
        public BinaryModelConfig( string modelFilename, int modelDictionaryCapacity = 0 ): this( Enumerable.Repeat( modelFilename, 1 ), modelDictionaryCapacity ) { }
